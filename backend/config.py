...
class Settings:
    ...
    raw_model: str = os.getenv("GEMINI_MODEL", "gemini-3.1-flash-lite")
    GEMINI_MODEL: str = "gemini-3.1-flash-lite" if ("2.5" in raw_model or "3.5" in raw_model) else raw_model
